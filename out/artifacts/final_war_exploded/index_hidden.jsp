...
<head>
    <title>登录</title>
    <link rel="stylesheet" href="css/index_hidden.css" charset="UTF-8">
...
<div id="login-box">
    ...
    <h1>大学生创新项目管理系统——教师系统</h1>

    <div class="nav">

        <ul id="list">
            <li class="current_li current me" onclick="change1()" id="me_1">登录</li>
            <li onclick="change2()" class="me" id="me_2">查看密钥</li>
        </ul>

    </div>
    <form action="admin_login" class="con_1" method="post">
        <div class="form ">
            <div class="item">
    ...
    <form action=""   class="con_2" method="post" style="display: none">
        <div class="form " >
            <div class="item">
                <i class="fa fa-user-circle-o" aria-hidden="true"></i>
                <input id="xuehao_register" name="userId" type="text" value="id:admin" required/>
            </div>
            <div class="item">
                <i class="fa fa-key" aria-hidden="true"></i>
                <input id="password_register" name="userPwd1" type="password" value="密码:admin" required/>
            </div>
        </div>
    </form>
    <div class="quickzone">
